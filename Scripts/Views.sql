...
SELECT 
    ...
    b_origen.ubicacion AS ubicacion_bodega_origen,    -- Ubicación de la bodega de origen
    b_destino.ubicacion AS ubicacion_bodega_destino    -- Ubicación de la bodega de destino
FROM 
    Movimiento mo
JOIN 
